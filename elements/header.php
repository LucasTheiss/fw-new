...
$baseUrl = "/FuelWise/pages"; // Ajuste este caminho se necessário
?>
        ...
        <nav class="header-nav" id="main-nav">
            <ul>
                <?php if (!isset($_SESSION['id'])): ?>
                    ...
                    <li><a href="<?= $baseUrl ?>/cadastro_transportadora.php?page=1">Cadastrar Transportadora</a></li>
                    <li><a href="<?= $baseUrl ?>/login.php" class="btn primary">Login</a></li>

                <?php elseif (isset($_SESSION['gerente']) && $_SESSION['gerente'] == '0' && $_SESSION['adm'] == '0'): ?>
                ...
                <?php elseif (isset($_SESSION['gerente']) && $_SESSION['gerente'] == '1'): ?>
                ...
                <?php elseif (isset($_SESSION['adm']) && $_SESSION['adm'] == '1' || (isset($_SESSION['role']) && $_SESSION['role'] == 3)): ?>
                    <li><a href="<?= $baseUrl ?>/adm/index.php">Dashboard</a></li>
                    <li><a href="<?= $baseUrl ?>/adm/solicitacoes.php">Solicitações</a></li>
                    <li><a href="<?= $baseUrl ?>/adm/postos.php">Postos</a></li>
                    <li><a href="<?= $baseUrl ?>/adm/denuncias.php">Denúncias</a></li>
                    <li><a href="<?= $baseUrl ?>/logout.php">Sair</a></li>
                <?php endif; ?>

                <?php if (isset($_SESSION["nome"])): ?>
                    <li class="nav-user-info"><?= htmlspecialchars($_SESSION["nome"]); ?></li>
                <?php endif; ?>
            </ul>
        </nav>
